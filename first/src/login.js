...
import logo from './images/rabbit.jpg'
...
function Login(){
    ...
    return(
        <div className='full-height'>
            <div id='header' className='loginheader'>Goutham mart</div>
            ...
            <div id='footer' className='loginfooter'>Copyright @Goutham mart. All rights reserved.</div>
        </div>
    );
}
